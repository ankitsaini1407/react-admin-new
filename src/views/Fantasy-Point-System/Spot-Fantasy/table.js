...
import AddSpotFantasyPoints from "./add";

const SpotFantasyPoints = () => {
    ...
    try {
      await axios
        .get(`${get_download_banner}?page=${
          pageNumber - 1
        }&size=${perPage}&subType=spot-fantasy-points`, {
      ...
      {modalShow1 ? (
        ...
        >
          ...
          <Modal.Body style={{display:"flex",alignItems:"center",justifyContent:"center"}}>
            <img src={modalInfo1} height={600} width={400} />
          </Modal.Body>
        </Modal>
      ) : (
        ""
...
export default SpotFantasyPoints;

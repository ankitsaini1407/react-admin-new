...
const DownloadTopImage = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, action) => {
      if (imageError == "") {
        ...
        await axios
          .post(`${add_download_banner}?subType=banner1`, formData, {
  ...
  const checkImage = (e) => {
    ...
    e.target.naturalWidth === 1012 && e.target.naturalHeight === 729
      ? ""
...
export default DownloadTopImage;

...
const DownloadBanner2 = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, action) => {
      if (imageError == "") {
        ...
        await axios
          .post(`${add_download_banner}?subType=banner2`, formData, {
  ...
  const checkImage = (e) => {
    ...
    e.target.naturalWidth === 1284 && e.target.naturalHeight === 2778
      ? ""
...
export default DownloadBanner2;

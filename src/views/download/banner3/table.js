...
import DownloadBanner3 from "./add";

const DownloadBanner3Table = () => {
      ...
      {modalShow1 ? (
        ...
        >
          ...
          <Modal.Body style={{display:"flex",alignItems:"center",justifyContent:"center"}}>
            <img src={modalInfo1} height={400} width={500} />
          </Modal.Body>
        </Modal>
      ) : (
        ""
...
export default DownloadBanner3Table;

...
import { add_term_condition } from "../../utils/APIRoutes";
...
const AddTCCms = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, action) => {
      ...
      await axios.post(`${add_term_condition}?type=${type}&subType=${subType}`, {
        title,
        value,
    ...
    <div>
      <div>
        ...
        <Form.Select
          ...
          <option value="referEarn">Refer&Earn</option>
